...
keys = [
    ...
    Key([mod, "shift"], "Return", lazy.spawn("rofi -matching fuzzy -show drun"), desc="Spawn rofi"),
    Key([mod], "r", lazy.spawncmd(), desc="Spawn a command using a prompt widget"),
    Key([mod], "b", lazy.hide_show_bar(), desc="Toggle the bar"),
    KeyChord([mod], "a", [
        KeyChord([], "w", [
            Key([], "w", lazy.spawn(browser), desc="Launch browser"),
            Key([], "e", lazy.spawn("firefox -P Escuela"), desc="Profile for school"),
        ], name="Browser"),
    ...
    # Dmenu/Rofi
    KeyChord([mod], "p", [
        Key([], "e", lazy.spawn("rofi -show emoji -emoji-mode menu"), desc="Emoji selector"),
    ...
    # Media keys
    Key([], "XF86Calculator", lazy.spawn("rofi -show calc -no-show-match -no-sort"), desc="Launch Calculator"),
